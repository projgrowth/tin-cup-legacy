...
export function PhotoPicker({
  ...
  const btn =
    size === "compact"
      ? "press t-micro inline-flex min-h-10 flex-1 items-center justify-center gap-1.5 rounded-lg border border-border px-2.5 text-muted-foreground disabled:opacity-50"
